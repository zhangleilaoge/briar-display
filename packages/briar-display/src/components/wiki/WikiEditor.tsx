...
import { type WikiArticle, wikiApi } from '@/api/wiki'
...
export default function WikiEditor({ articleId, onSuccess, onCancel }: WikiEditorProps) {
	...
	const handleSave = async () => {
		...
		try {
			...
			const errorMessage = err instanceof Error ? err.message : 'Error saving article'
		...
		<div className="w-full max-w-6xl mx-auto p-4">
			...
			<div className="bg-white rounded-lg border border-gray-200 p-6">
				...
				<div className="p-4 bg-gray-50 rounded-lg text-sm text-gray-600">
					...
					<p className="mt-2">
						💡 Tip: Use Markdown syntax for formatting. Headers, lists, code blocks, and more are
						supported!
					</p>
				</div>
			</div>
