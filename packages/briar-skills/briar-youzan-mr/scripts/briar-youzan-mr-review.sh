#!/bin/bash
# briar-youzan-mr-review.sh - MR 评论操作（fetch / comment / reply / diff / find / post-notes）
#
# Usage:
#   ./briar-youzan-mr-review.sh fetch         <domain> <project_path> <mr_iid>
#   ./briar-youzan-mr-review.sh comment       <domain> <project_path> <mr_iid> <body>
#   ./briar-youzan-mr-review.sh reply         <domain> <project_path> <mr_iid> <discussion_id> <body>
#   ./briar-youzan-mr-review.sh diff          <domain> <project_path> <mr_iid>
#   ./briar-youzan-mr-review.sh find          <domain> <project_path> <source_branch>
#   ./briar-youzan-mr-review.sh post-notes    <domain> <project_path> <mr_iid> <comments.json>
#
...
infer_base_dir() {
	...
	REPO_SCRIPT="$(cd "$(dirname "$0")/../../briar-youzan-repo/scripts" && pwd)/briar-youzan-repo.sh"
