#!/bin/bash
# briar-youzan-mr-pending.sh - 列出当前用户最近 N 天 open MR 中未回复的实质性人工评论
#
# Usage: ./briar-youzan-mr-pending.sh [arg...]
#
# 参数智能识别（顺序无关）：
...
#
# Examples:
#   ./briar-youzan-mr-pending.sh                          # 默认 30 天，全部仓库
#   ./briar-youzan-mr-pending.sh 7                        # 最近 7 天，全部仓库
#   ./briar-youzan-mr-pending.sh scrm-mono                # 最近 30 天，scrm-mono 仓库
#   ./briar-youzan-mr-pending.sh 7 scrm-mono              # 最近 7 天，scrm-mono 仓库
#   ./briar-youzan-mr-pending.sh gitlab.qima-inc.com 7 scrm-mono
#
