...
# 或
./scripts/briar-youzan-mr.sh pipeline <domain> <project_path> <mr_iid>
```
...
**代码修复由 briar-youzan-fix 处理**，流程如下：

```
briar-youzan-mr pipeline（获取失败日志）
  ↓
...
详见 [briar-youzan-fix 文档](../../briar-youzan-fix/SKILL.md)。
...
# 用户确认后提交
../../briar-youzan-fix/scripts/briar-youzan-fix.sh commit <worktree_path> "fix: 修复 CI 失败"
