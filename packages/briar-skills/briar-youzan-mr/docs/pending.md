...
```bash
./briar-youzan-mr-pending.sh [domain] [days] [project_filter]
# 或
./briar-youzan-mr.sh pending [domain] [days] [project_filter]
```
...
# 最近 7 天，全部仓库
./briar-youzan-mr-pending.sh 7

# 最近 30 天，scrm-mono 仓库（模糊匹配）
./briar-youzan-mr-pending.sh scrm-mono
