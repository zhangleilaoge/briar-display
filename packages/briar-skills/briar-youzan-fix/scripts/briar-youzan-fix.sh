#!/bin/bash
# briar-youzan-fix.sh - 代码修复工作流脚本
# Usage:
#   ./briar-youzan-fix.sh verify  <worktree_path>
#   ./briar-youzan-fix.sh diff    <worktree_path>
#   ./briar-youzan-fix.sh commit  <worktree_path> <message>
#   ./briar-youzan-fix.sh push    <worktree_path>
#
# worktree 的创建/删除用 git worktree 原生命令（见 briar-youzan-repo SKILL.md「三、Worktree 管理」），本脚本只负责 worktree 内的修复操作。
