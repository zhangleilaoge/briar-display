import { wikiDal, type WikiRecord } from "../dal/wikiDal"
...
export const wikiService = {
   ...
   * 获取已发布的文章列表
   */
  async getPublishedList(limit: number = 20, offset: number = 0) {
  ...
  async update(
    ...
    // 如果标题改变，重新生成 slug
    let updateData: Parameters<typeof wikiDal.update>[1] = {
      ...input,
    }
